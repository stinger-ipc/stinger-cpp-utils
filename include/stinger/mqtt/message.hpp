...
struct Message {
    ...
    static Message PropertyValue(const std::string& topic, const std::string& payload,
                                 std::optional<int> propertyVersion);

    static Message PropertyUpdateRequest(const std::string& topic, const std::string& payload,
                                         std::optional<int> propertyVersion,
                                         const std::vector<std::byte>& correlationData,
                                         const std::string& responseTopic);

    static Message PropertyUpdateResponse(const std::string& topic, const std::string& payload,
                                          std::optional<int> propertyVersion,
